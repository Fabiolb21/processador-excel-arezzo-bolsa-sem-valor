...
10. **NUM DA ETQ**: Contém uma numeração crescente começando em 000001 com zeros à frente
11. **VALOR DO FILTRO**: Recebe em todas as linhas o valor 1
12. **PREFIXO DA EMP**: Recebe os 7 primeiros caracteres da coluna EAN
13. **ITEM DE REF**: Recebe do oitavo ao décimo segundo caractere da coluna EAN acrescido de um zero na frente
14. **SERIAL**: Coluna vazia
